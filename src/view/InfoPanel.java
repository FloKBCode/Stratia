...
/**
 * InfoPanel : bandeau supérieur — joueur actuel, score, chrono, état.
 */
public class InfoPanel extends JPanel {
    ...
    public InfoPanel(JeuController controller) {
        ...
        lblB.setForeground(new Color(180,180,180)); lblB.setFont(new Font("Arial",Font.PLAIN,10));
        ...
        lblN.setForeground(new Color(180,180,180)); lblN.setFont(new Font("Arial",Font.PLAIN,10));
    ...
    private JLabel chronoLabel() {
        ...
        l.setForeground(new Color(200, 230, 200));
    ...
    public void actualiser() {
        ...
        chronoBlancLabel.setForeground(critB ? new Color(255,80,80) : new Color(200,230,200));
        chronoNoirLabel .setForeground(critN ? new Color(255,80,80) : new Color(200,230,200));

        if (jeu.isPartieTerminee()) {
            joueurLabel.setText("🏆 " + jeu.getVainqueur().getNom() + " gagne !");
            joueurLabel.setForeground(new Color(255, 200, 50));
        ...
        joueurLabel.setText("Tour : " + jeu.getJoueurActuel().getNom() + (estBlanc?" ○":" ●"));
        joueurLabel.setForeground(estBlanc ? new Color(240,240,200) : new Color(130,160,255));

        if (botTour) {
            messageLabel.setText("🤖 Le bot réfléchit…");
            ...
            messageLabel.setText("Cliquez sur une pièce surlignée");
